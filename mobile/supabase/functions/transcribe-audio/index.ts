...
serve(async (req) => {
    ...
    try {
        ...
        reportInfo('Starting OpenAI Whisper transcription', 'transcribe-audio:openai_start', {
            recording_id,
            trace_id: traceId,
            span_id: spanId
        });
        ...
        if (openAIData.error || !openAIResponse.ok) {
            ...
            await reportError(err, 'transcribe-audio:openai', {
                recording_id,
                trace_id: traceId,
                span_id: spanId
            });
        ...
        reportInfo('Transcription successful from OpenAI', 'transcribe-audio:openai_complete', {
            recording_id,
            trace_id: traceId,
            span_id: spanId
        });
        ...
        reportInfo('Transcription completed', 'transcribe-audio', {
            recording_id,
