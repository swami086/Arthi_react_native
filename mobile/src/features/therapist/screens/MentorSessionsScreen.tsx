...
const FIGMA_ASSETS = {
    ...
    mentee1: "http://localhost:3845/assets/7103c235af4cc34d7f3959a4ca31967f172abfd2.png",
    mentee2: "http://localhost:3845/assets/4223cd475ca66e463b2fe2d012226ea24ade734b.png",
    mentee3: "http://localhost:3845/assets/37964c109eade064f21d5ebb026d9eef0c99890b.png",
    mentee4: "http://localhost:3845/assets/650c2217681ff7ec466929dea9bbd32b84d165ad.png",
};
                ...
                <View className="flex-1 p-6 pr-2">
                    ...
                    <View className="flex-row items-center mb-6">
                        <View className="w-9 h-9 rounded-full bg-[#3B82F6] items-center justify-center mr-3 overflow-hidden border-2 border-[#1a2121]">
                            <Image
                                source={{ uri: item.mentee?.avatar_url || FIGMA_ASSETS.mentee1 }}
