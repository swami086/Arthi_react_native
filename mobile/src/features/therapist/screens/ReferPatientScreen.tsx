...
import { referPatientToTherapist } from '../../../api/therapistService';
...
export const ReferPatientScreen = () => {
    ...
    const confirmReferral = async () => {
        ...
        try {
            await referPatientToTherapist(patientId, user.id, targetTherapistId, referralReason || 'No reason provided');
