        ...
        <View className="bg-white dark:bg-gray-800 p-4 rounded-xl mb-3 shadow-sm">
            <View className="flex-row justify-between mb-2">
                <Text className="font-bold text-base text-text-main-light dark:text-white">
                    {viewMode === 'received' ? `From: ${item.referring_therapist?.full_name}` : `To: ${item.referred_to_therapist?.full_name}`}
                </Text>
            ...
            <Text className="text-sm font-semibold mb-1 text-text-main-light dark:text-gray-300">Patient: {item.patient_name || 'Patient'}</Text>
