            ...
            <View className="flex-1 gap-2">
                ...
                <View className="flex-row gap-2 mt-1">
                    ...
                    {onRemove && (
                        <TouchableOpacity
                            onPress={onRemove}
                            className="bg-red-50 dark:bg-red-900/20 px-3 py-2 rounded-xl items-center justify-center"
                        >
                            <MaterialCommunityIcons name="account-remove-outline" size={16} color={status === 'Active' ? '#ef4444' : tokens.colors.text.disabled.light} />
                        </TouchableOpacity>
                    )}
                </View>
            </View>
