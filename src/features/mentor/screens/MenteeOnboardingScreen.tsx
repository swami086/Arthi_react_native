...
export const MenteeOnboardingScreen = () => {
    ...
    const steps = [
        ...
        { id: '3', title: 'Schedule Kick-off', desc: 'Book the first mentoring session', icon: 'calendar-clock', done: false, action: 'Sessions' },
            ...
            <ScrollView contentContainerStyle={{ padding: 24 }}>
                <View className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-xl mb-6">
                    <Text className="text-blue-800 dark:text-blue-300">
                        Use this checklist to ensure you cover all basics when starting with a new mentee.
                    </Text>
                </View>
                ...
                {steps.map((step, index) => (
                    <TouchableOpacity
                        ...
                        onPress={() => {
                            if (step.action === 'AddGoal' && menteeId) {
                                navigation.navigate('AddGoal', { menteeId });
