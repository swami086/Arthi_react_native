...
import { reportError, reportInfo, reportWarning } from '../../../services/rollbar';
...
export const RollbarDebugScreen = () => {
    ...
    const handleUncaughtError = () => {
        // This will be caught by ErrorBoundary if wrapped, or global handler
        // We simulate a crash inside an event handler which is often caught by RN global handler
        const a: any = {};
        a.b.c = 0; // Throws TypeError
    };

    const handleRenderError = () => {
        // This component will re-render and crash
            ...
            <ScrollView contentContainerStyle={styles.content}>
                ...
                <View style={styles.codeBlock}>
                    <Text style={styles.codeText}>
                        curl -X POST https://pqjwldzyogmdangllnlr.supabase.co/functions/v1/create-payment-order \
