...
export default async function SessionDetailPage({ params }: SessionDetailPageProps) {
    ...
    // 5. Fetch Transcript for Copilot
    ...
    return (
        <div className="min-h-screen bg-background-light dark:bg-[#0e181b] flex flex-row">
            ...
            <A2UICopilotSidebar
                ...
                userId={user.id}
                className="hidden xl:flex sticky top-0 h-screen"
            />
        </div>
    );
}
