...
export default function TherapistHomeClient({ initialStats, initialAppointments, initialConversations, user }: TherapistHomeClientProps) {
    ...
    useEffect(() => {
        console.log('TherapistHomeClient mounted', { user, initialStats, initialAppointments, initialConversations });
    }, [user, initialStats, initialAppointments, initialConversations]);
