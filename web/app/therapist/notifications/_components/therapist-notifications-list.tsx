...
import NotificationCard from '@/app/(main)/notifications/_components/notification-card';
import { useRouter } from 'next/navigation';

interface TherapistNotificationsListProps {
    initialNotifications: any[];
}

export default function TherapistNotificationsList({ initialNotifications }: TherapistNotificationsListProps) {
    ...
    const handleNotificationClick = (n: any) => {
        ...
        // Navigation logic for THERAPISTS
        if (n.type === 'message' && n.related_entity_id) {
            router.push(`/therapist/messages/${n.related_entity_id}`);
        } else if (n.type === 'appointment') {
            router.push('/therapist/sessions');
        } else if (n.type === 'payment') {
            router.push('/therapist/payments');
        } else if (n.type === 'referral') {
            router.push('/therapist/referrals');
        }
    };
